...
from src.lib.Encoder import to_samples
from src.lib.Network import nn_predict
from src.lib.SiameseNetwork import siamese_nn_predict
...
def start_predictions(FLAGS: argparse.Namespace):
