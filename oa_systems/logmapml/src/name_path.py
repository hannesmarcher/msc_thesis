...
from owlready2 import get_ontology, entity, owl

from src.lib.Label import uri_prefix
...
def extract_names_and_paths(onto_file: str, name_file: str, path_file: str):
    ...
    json.dump(class_name, open(name_file, 'w'))
...
if __name__ == "__main__":
    extract_names_and_paths(FLAGS.onto_file, FLAGS.name_file, FLAGS.path_file)