...
from us_bertmap.utils.helpers import uniqify, exclude_randrange
    ...
    def intra_onto_soft_nonsynonyms(self):
        ...
        for class_iri, text_dict in self.onto_box.onto_text.texts.items():
            ...
            for label in labels:
                ...
                neg_idxs = [
                    exclude_randrange(0, num_classes, exclude=idx) for _ in range(self.sample_rate)
                ]
        ...
        for cl in self.onto_box.onto.classes():
            ...
            if self.depth_threshold and self.depth_strategy:
                ...
                if depth > self.depth_threshold:
                    continue
            sub_classes = [
                self.onto_box.onto_text.abbr_entity_iri(scl.iri) for scl in cl.subclasses()
            ]
