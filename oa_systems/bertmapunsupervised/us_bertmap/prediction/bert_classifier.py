...
from us_bertmap.prediction.bert_static import BERTStatic
from us_bertmap.prediction.onto_mapping import OntoMapping
from us_bertmap.utils.helpers import get_device
    ...
    def batch_alignment(self, from_labels: List[str], search_space: List[str], flag: str):
        ...
        for to_batch in to_labels_iterator:
            ...
            with torch.no_grad():
                ...
                pooled_batch_scores = self.batch_pooling(batch_scores,
                                                         batch_lens)  # torch.Size([to_batch_size]), singleton
